        ...
        <div class="bg-teal-200 p-2 h-3/4 py-8 w-11/12 sm:w-9/12 rounded-lg my-8 flex drop-shadow-xl lg:w-1/2">
            <div class="flex-1 flex-shrink md:flex-shrink-0">
                <div class="block sm:ps-10 flex items-center justify-center my-4">
                    <h1 class="text-xl lg:text-3xl font-bold">Report Found Item</h1>
                </div>
                <div class="mt-4 lg:mt-0">
                    <form action="/items/create/found" method="POST" class="flex flex-col justify-center space-y-3 items-center sm:space-y-2">
                        @csrf
                        ...
                        <h3 class="font-semibold text-xl">Finder Details</h3>
